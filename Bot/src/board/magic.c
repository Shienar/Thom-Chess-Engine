...
uint64_t naiveBishop(int square, uint64_t occupancy, int useOccupancy)
{
    ...
    if(useOccupancy)
    {
        ...
        {
            potentialMoves |= (1ull << (8 * r + c));
            if((1ull << (8 * r + c)) & occupancy) break;
        }
...
uint64_t naiveRook(int square, uint64_t occupancy, int useOccupancy)
{
    ...
    if(useOccupancy)
    {
        ...
        {
            potentialMoves |= (1ull << (8 * row + c));
            if((1ull << (8 * row + c)) & occupancy) break;
        }
        ...
        {
            potentialMoves |= (1ull << (8 * r + column));
            if((1ull << (8 * r + column)) & occupancy) break;
        }
...
void initMagics()
{
    ...
    for(int square = 0; square < 64; square++)
    {
        ...
        for(int i = 0; i < occ_rook; i++)
        {
            ...
            if(rookMagic->attacks[magicIndex]) DEBUG("Collision detected at index %d", magicIndex + (startIndex_rook - rookTable));
        ...
        for(int i = 0; i < occ_bishop; i++)
        {
            ...
            if(bishopMagic->attacks[magicIndex]) DEBUG("Collision detected at index %d", magicIndex + (startIndex_bishop - bishopTable));
...
void initPawnAttacks()
{
    for(int square = 0; square < 64; square++)
    {
        ...
        if(row < 7)
        {
            if(column > 0) pawnAttacks[0][square] |= (1ull<<(square+7));
            if(column < 7) pawnAttacks[0][square] |= (1ull<<(square+9));
        }

        //black
        if(row > 0)
        {
            if(column > 0) pawnAttacks[1][square] |= (1ull<<(square-9));
            if(column < 7) pawnAttacks[1][square] |= (1ull<<(square-7));
        }
    }
}
...
void initKnightMoveTable()
{
    for(int square = 0; square < 64; square++)
    {
        ...
        */
        ...
        if(column - 2 >= 0 && row + 1 <= 7) knightAttacks[square]|=(1ull<<(square+6));
        if(column - 1 >= 0 && row + 2 <= 7) knightAttacks[square]|=(1ull<<(square+15));
        if(column + 1 <= 7 && row + 2 <= 7) knightAttacks[square]|=(1ull<<(square+17));
        if(column + 2 <= 7 && row + 1 <= 7) knightAttacks[square]|=(1ull<<(square+10));
        if(column + 2 <= 7 && row - 1 >= 0) knightAttacks[square]|=(1ull<<(square-6));
        if(column + 1 <= 7 && row - 2 >= 0) knightAttacks[square]|=(1ull<<(square-15));
        if(column - 1 >= 0 && row - 2 >= 0) knightAttacks[square]|=(1ull<<(square-17));
        if(column - 2 >= 0 && row - 1 >= 0) knightAttacks[square]|=(1ull<<(square-10));
    }
}
...
void initKingMoveTable()
{
    ...
    for(int square = 0; square < 64; square++)
    {
        ...
        */
        if(column - 1 >= 0 && row + 1 <= 7) kingAttacks[square]|=(1ull<<(square+7));
        if(row + 1 <= 7) kingAttacks[square]|=(1ull<<(square+8));
        if(column + 1 <= 7 && row + 1 <= 7) kingAttacks[square]|=(1ull<<(square+9));
        if(column - 1 >= 0) kingAttacks[square]|=(1ull<<(square-1));
        if(column + 1 <= 7) kingAttacks[square]|=(1ull<<(square+1));
        if(column - 1 >= 0 && row - 1 >= 0) kingAttacks[square]|=(1ull<<(square-9));
        if(row - 1 >= 0) kingAttacks[square]|=(1ull<<(square-8));
        if(column + 1 <= 7 && row - 1 >= 0) kingAttacks[square]|=(1ull<<(square-7));
    }
}