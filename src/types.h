...
#define MAX_PLY 40 //TODO - Increasing to 60 results in a loss of 40 elo, bur onlt when singular extensions are enabled.
...
#define INPUT_BITS_PER_SIDE (BITS_PER_KING_BUCKET * KING_BUCKETS)
